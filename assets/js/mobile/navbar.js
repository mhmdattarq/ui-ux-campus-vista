...
<a data-nav-link data-nav-parent="explore" href="explore-ruang-kelas.html" class="nav-dropdown-link flex items-center gap-3 block px-4 py-3 text-xs rounded-xl text-slate-600 hover:text-[#1B4EF5] hover:bg-gradient-to-r hover:from-[#1B4EF5]/5 hover:to-transparent transition-all duration-200 hover:scale-[1.02] hover:shadow-sm">
                    ...
                    <a data-nav-link data-nav-parent="explore" href="explore-perpustakaan.html" class="nav-dropdown-link flex items-center gap-3 block px-4 py-3 text-xs rounded-xl text-slate-600 hover:text-[#1B4EF5] hover:bg-gradient-to-r hover:from-[#1B4EF5]/5 hover:to-transparent transition-all duration-200 hover:scale-[1.02] hover:shadow-sm">
                        <span>📚</span> Perpustakaan
                    </a>
                    <a data-nav-link data-nav-parent="explore" href="explore_musholla.html" class="nav-dropdown-link flex items-center gap-3 block px-4 py-3 text-xs rounded-xl text-slate-600 hover:text-[#1B4EF5] hover:bg-gradient-to-r hover:from-[#1B4EF5]/5 hover:to-transparent transition-all duration-200 hover:scale-[1.02] hover:shadow-sm">
                        <span>🕌</span> Musholla
                    </a>
<a data-nav-link data-nav-parent="explore" href="explore-kantin.html" class="nav-dropdown-link flex items-center gap-3 block px-4 py-3 text-xs rounded-xl text-slate-600 hover:text-[#1B4EF5] hover:bg-gradient-to-r hover:from-[#1B4EF5]/5 hover:to-transparent transition-all duration-200 hover:scale-[1.02] hover:shadow-sm">
                         <span>☕</span> Kantin
                     </a>
                     <a data-nav-link data-nav-parent="explore" href="explore-lapangan.html" class="nav-dropdown-link flex items-center gap-3 block px-4 py-3 text-xs rounded-xl text-slate-600 hover:text-[#1B4EF5] hover:bg-gradient-to-r hover:from-[#1B4EF5]/5 hover:to-transparent transition-all duration-200 hover:scale-[1.02] hover:shadow-sm">
                         <span>⚽</span> Lapangan
                    </a>
                </div>
            </div>
...
<a data-nav-link data-nav-parent="explore" href="explore-ruang-kelas.html" class="nav-link-mobile flex items-center gap-2 rounded-xl px-3 py-2.5 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#1B4EF5]/5 hover:to-transparent hover:text-[#1B4EF5] hover:shadow-sm hover:scale-[1.02]">
                         <span>🚪</span> Kelas
                        </a>
                        ...
                        <a data-nav-link data-nav-parent="explore" href="explore-perpustakaan.html" class="nav-link-mobile flex items-center gap-2 rounded-xl px-3 py-2.5 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#1B4EF5]/5 hover:to-transparent hover:text-[#1B4EF5] hover:shadow-sm hover:scale-[1.02]">
                            <span>📚</span> Perpus
                        </a>
                        <a data-nav-link data-nav-parent="explore" href="explore_musholla.html" class="nav-link-mobile flex items-center gap-2 rounded-xl px-3 py-2.5 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#1B4EF5]/5 hover:to-transparent hover:text-[#1B4EF5] hover:shadow-sm hover:scale-[1.02]">
                            <span>🕌</span> Musholla
                        </a>
<a data-nav-link data-nav-parent="explore" href="explore-kantin.html" class="nav-link-mobile flex items-center gap-2 rounded-xl px-3 py-2.5 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#1B4EF5]/5 hover:to-transparent hover:text-[#1B4EF5] hover:shadow-sm hover:scale-[1.02]">
                         <span>☕</span> Kantin
                     </a>
                     <a data-nav-link data-nav-parent="explore" href="explore-lapangan.html" class="nav-link-mobile flex items-center gap-2 rounded-xl px-3 py-2.5 transition-all duration-200 hover:bg-gradient-to-r hover:from-[#1B4EF5]/5 hover:to-transparent hover:text-[#1B4EF5] hover:shadow-sm hover:scale-[1.02]">
                         <span>⚽</span> Lapangan
                        </a>
                    </div>
                </div>
                ...
                <a href="../index.html" target="campus-desktop" class="nav-link-mobile rounded-xl pl-1 pr-4 py-3 transition-all duration-200 hover:bg-gradient-to-r hover:from-slate-100 hover:to-slate-50 hover:text-slate-900 hover:shadow-sm hover:scale-[1.02] flex items-center gap-2">
    ...
    navLinks.forEach((link) => {
        ...
        if (linkPage === currentPage && linkPage !== 'index.html') {
            ...
            if (linkParent) {
                ...
                // Auto-buka section di panel mobile
                const panel = document.getElementById('navbar-mobile-panel');
                if (panel) {
                    var sectionNames = { about: 'About', prodi: 'Program Studi', explore: 'Explore' };
                    var targetName = sectionNames[linkParent];
                    if (targetName) {
                        var headers = panel.querySelectorAll('nav > div > p:first-child');
                        headers.forEach(function (h) {
                            if (h.textContent.trim() === targetName) {
                                var wrapper = h.parentNode;
                                var content = wrapper.querySelector(':scope > div');
                                var indicator = h.querySelector('span');
                                if (content) {
